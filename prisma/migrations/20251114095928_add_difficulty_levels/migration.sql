...
CREATE TABLE "articles" (
    ...
    "content_intermediate" TEXT,
    "content_advanced" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "word_favorites_user_id_article_id_word_key" ON "word_favorites"("user_id", "article_id", "word");
...
-- AddForeignKey
ALTER TABLE "word_favorites" ADD CONSTRAINT "word_favorites_article_id_fkey" FOREIGN KEY ("article_id") REFERENCES "articles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
